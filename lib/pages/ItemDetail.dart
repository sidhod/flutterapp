...
import 'package:untitled3/controller/homePageController.dart';
import 'package:untitled3/models/ItemModel.dart';
import 'package:untitled3/widgets/CustomButton.dart';
import 'package:untitled3/widgets/DotWidget.dart';
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: (num == index) ? Colors.black38 : Colors.grey,
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: 10.0),
                    child: Text(
                        "Want to make an impression in the boardroom or slay in style at that sundowner? The Indian Terrain checkered slim fit casual pine melange shirt is all you need to make a stylish appearance. This full sleeves, regular collared shirt also features a chest pocket for comfort. Add this 1% cotton shirt to your closet and ooze confidence wherever you go"),
                  )
                ],
              ),
            )
